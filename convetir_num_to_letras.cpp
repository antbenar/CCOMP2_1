...
private:
    ...
    void decenas(int posPalabras, int temp){//usado para dar nombre a los dos primeros numeros
        p2=palabras[posPalabras];
        if(temp!=0){
            p2+="y ";
            p2+=palabras[temp];
        }
    ...
    void unid_y_dec(int num1){//da nombre a los dos primeros numeros
        if(num1<=20)
            p2=palabras[num1];
        else if(num1<30){
            p2=palabras[21];
        ...
        else if(num1<60)decenas(25, num1%10);
        else if(num1<70)decenas(26, num1%10);
        else if(num1<80)decenas(27, num1%10);
        else if(num1<90)decenas(28, num1%10);
        else if(num1<100)decenas(29, num1%10);
    }

    void centenas(int num1){
        if(num1==100)
            p2=palabras[30];
        else{
            unid_y_dec(num1%100);
    ...
    void millar(long long num1){
        ...
        if(num1<2000&&num1>=1000)
            p3.insert(0,palabras[40]);//Evitar el un mil
        else if(num1>=2000){
            centenas(num1/1000);
